...
describe("GravityTrader", function () {
  ...
  it("deposits erc20 token", async function () {
    ...
    const depositTxn = await gravityTrader.initiateNewStrategy(usdcToken.address,linkToken.address,initialSupply,7,purchasePercentage);
  ...
  it.only("withdraws erc20 token", async function () {
    ...
    const depositusdcTxn = await gravityTrader.initiateNewStrategy(usdcToken.address,linkToken.address,initialSupply,7,purchasePercentage);
    ...
    const depositLinkTxn = await gravityTrader.initiateNewStrategy(linkToken.address,usdcToken.address,initialSupply,7,purchasePercentage);
    ...
    const withdrawTxn = await gravityTrader.withdraw(1);
